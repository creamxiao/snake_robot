...
#include "configuration_search_no_precal.hpp"
...
int main(int argc, char *argv[])
{
  ...
  for(auto i : allLks.back().forces){
	...
	sprintf(imgFname, "outfiles/%s_%d_%d_%d_%d_%d_C4_%g_2nd_search_duration_%d_mins_%d_secs_%s.png", argv[0], 1900 + localtm->tm_year, 1 + localtm->tm_mon, localtm->tm_mday, localtm->tm_hour, localtm->tm_min, C4, (int)((search_1_duration + searchInstance_2.duration) / 60), (int)(search_1_duration + searchInstance_2.duration) % 60, _OS_FLAG == 1? "Linux" : "Mac");
